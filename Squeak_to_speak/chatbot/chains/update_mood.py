...
class IdentifyMoodBoardEntryToModify:
    def get_entry_to_modify(self, user_input):
        """
        Parses the user input to identify the entry the user wants to modify.
...
class InformUserOfMoodBoardChange:
    def format_output(self, modification_result):
        ...
        return (
            f"Your mood board entry with ID {modification_result['entry_id']} "
