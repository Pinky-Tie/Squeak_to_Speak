...
class MoodBoardDeletionConfirmationFormatter:
    def format_output(self, deletion_result, entry_id):
        ...
        if deletion_result:
            return f"Mood board entry with ID {entry_id} has been successfully deleted."
        return f"Unable to delete the mood board entry with ID {entry_id}. Please ensure the entry ID is correct."
